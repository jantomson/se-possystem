...
public class ConsoleUI {
    ...
    private void showTeamInfo() {
        System.out.println("-------------------------");
        System.out.println("Team name: INF999");
        //System.out.println("Team leader: " + ee.ut.math.tvt.salessystem.ui.Java.util.TeamInfo.getTeamLeader());
        System.out.println("Team leader email: xxx.xxx@gmail.com");
        System.out.println("Team members: Jan Tomson, Enar Leini, Alvar Anvelt, Marko Smirnov");
        System.out.println("-------------------------");
    }
    ...
    private void printUsage() {
        ...
        System.out.println("t\t\tShow team members");
